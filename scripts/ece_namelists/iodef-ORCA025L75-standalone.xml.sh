...
============================================================================================================
    ...
    <file_definition type="multiple_file" name="@expname@_@freq@_@startdate@_@enddate@" sync_freq="10d" min_digits="4">
      ...
      <file_group id="1d" output_freq="1d" output_level="10" enabled=".TRUE.">  <!-- 1d files -->
        <file id="file1" name_suffix="_icemod" description="ice icemod variables" enabled=".TRUE.">
          <field field_ref="icevolu"     name="sivolu"     long_name="sea_ice_volume_per_unit_gridcell_area"/>
          <field field_ref="iceconc"     name="siconc"     long_name="sea_ice_concentration"/>
      ...
      <file_group id="1m" output_freq="1m" output_level="10" enabled=".TRUE."> <!-- 1m files -->
        ...
        <file id="file3" name_suffix="_SBC" description="surface fluxes variables" enabled=".FALSE."> <!-- time step automaticaly defined based on nn_fsbc -->
        ...
        <file id="file4" name_suffix="_grid_U" description="ocean U grid variables" enabled=".FALSE.">
        ...
        <file id="file5" name_suffix="_grid_V" description="ocean V grid variables" enabled=".FALSE.">
        ...
        <file id="file6" name_suffix="_grid_W" description="ocean W grid variables" enabled=".FALSE.">
        ...
        <file id="file7" name_suffix="_icemod" description="ice variables" enabled=".TRUE.">
        ...
        <file id="file9" name_suffix="_PISC_T" description="PISCES T grid variables" enabled=".FALSE.">
        ...
        <file id="file10" name_suffix="_PISC_series" description="PISCES T grid variables" enabled=".FALSE.">
        ...
        <file id="file11" name_suffix="_diaar5" description="PISCES T grid variables" enabled=".FALSE.">
        ...
        <file id="file12" name_suffix="_diad_T" description="PISCES additional diagnostics on T grid" enabled=".FALSE.">
