...
&NAMFPC
    ...
    MFP2DF         = 129,134,
    NFPPHY         = 31,
    MFPPHY         = 8,39,44,49,78,79,129,137,139,143,144,146,147,151,164,165,166,167,169,175,179,180,181,182,201,202,205,209,212,228,235,
    ...
    NFP3DFS        = 7,
    MFP3DFS        = 130,131,132,133,135,138,155,
    ...
    RFPCORR        = 60000.,
    NFP3DFP        = 9,
    MFP3DFP        = 129,130,131,132,133,135,138,155,157,
    LFITP          = TRUE,
    LFITT          = FALSE,
    LFITV          = FALSE,
    NFPCLI         = 0,
